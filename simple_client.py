...
from fus.responses import get_info_from_inform, parse_inform, InformInfo
...
inform_xml = client.inform(build_binary_inform(
    fwv = ver,
    model=model,
    region=region,
    device_id=imei,
...
print(f"Inform info: Latest FW: {info_inform.latest_fw_version}, Logic: {info_inform.logic_value_factory}, Filename: {info_inform.filename}, Path: {info_inform.path}, Size: {info_inform.size_bytes} bytes")
